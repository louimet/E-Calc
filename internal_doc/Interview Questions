...
* How much experience with calculators do you have
...
* time of day, 
* When working on a computer, on the go on my phone, while working on a tablet, etc.
* would a typical scenario entail the user already working on said device?
* etc…

3. Current use
* Do you use any particular type of calculator ?
* Which calculator do you use more often (physical/app)?
* If physical, what is the unattractive part of an app? (if any)
...
* if how do you qualify the tracking on your calculator?
