...
public class SquareRoot2 {
	...
	public static double calculate(double x) {
		...
		/**
		 * If the user enters a value less than 0, cannot compute square root.
		 * Display error.
		 */
		if (x < 0) {
		 ...
		 * because the algorithm used in this class ensures high precision.
		 * Hence, it is best to handle the sqrt(0) separately.
		 */
		else if (x == 0) {
			return 0;
		}
